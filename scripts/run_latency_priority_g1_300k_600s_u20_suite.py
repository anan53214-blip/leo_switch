...
full-suite directories:
    ...
    results/full_train_latency_priority_g1_300k_600s_u20_<run_id>
    results/baseline_compare/g1_300k_600s_u20_<run_id>
...
class SuiteConfig:
    ...
    exp_name: str = "han_mappo_latency_priority_g1_300k_600s_u20"
    algorithm: str = "mappo"
    seed: int = 42
    device: str = "auto"
    num_users: int = 20
